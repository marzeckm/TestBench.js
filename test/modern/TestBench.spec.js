...
describe('TestBench-Testingservice', () => {
    ...
    it('should handle spies correctly', () => {
        //given
        const testFunc = () => console.log("Fake function called!");
        const spy2 = TestBench().createSpy().and.callFake(testFunc);

        const originalFunc = () => console.log('Called original function');
        const spy3 = TestBench().createSpy('spy3', originalFunc);
